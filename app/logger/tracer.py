...
class ExecutionTraceLogger:
    ...
    def log_trace(
        ...
        rsicrc_execution_time: Optional[float] = None,
        rsicrc_result: Optional[Dict[str, Any]] = None,
        ...
        trace = ExecutionTrace(
            ...
            rsicrc_execution_time=rsicrc_execution_time,
            rsicrc_result=rsicrc_result,
